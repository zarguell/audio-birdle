...
describe('ShareUtils', () => {
  describe('generateShareText', () => {
    ...
    it('should generate share text for won game', () => {
      const shareText = generateShareText(completedGameState, 'https://audio-birdle.com')
    ...
    it('should generate share text for lost game', () => {
      const shareText = generateShareText(lostGameState, 'https://audio-birdle.com')
    ...
    it('should return empty string for incomplete game', () => {
      ...
      const shareText = generateShareText(incompleteState, 'https://audio-birdle.com')
    ...
    it('should handle single guess win', () => {
      ...
      const shareText = generateShareText(singleGuessState, 'https://audio-birdle.com')
  ...
  describe('shareResult', () => {
    const shareText = '🐦 Audio-Birdle 2025-12-27\nRegion: US\n2/4\n\n🟥🟩\n\nhttps://audio-birdle.com'
    ...
    it('should handle errors and show prompt as final fallback', async () => {
      global.navigator.clipboard.writeText = vi.fn().mockRejectedValue(new Error('Failed'))
      document.execCommand = vi.fn().mockReturnValue(false)
      global.prompt = vi.fn()
