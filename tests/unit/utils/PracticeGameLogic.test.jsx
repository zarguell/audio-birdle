...
describe("PracticeGameLogic", () => {
  ...
  describe("getPracticeBird", () => {
    ...
    it("should cycle through birds using modulo", () => {
      ...
      const bird3 = getPracticeBird(
        "us",
        sampleBirds,
        sampleBirds.us.length * 2,
      );
  ...
  describe("generatePracticeAnswerOptions", () => {
    it("should generate correct number of options", () => {
      ...
      const options = generatePracticeAnswerOptions(
        "us",
        sampleBirds,
        0,
        correctBird,
    ...
    it("should not include correct bird as wrong option", () => {
      ...
      const correctBirdCount = options.filter(
        (b) => b.id === correctBird.id,
      ).length;
    ...
    it("should be deterministic for same inputs", () => {
      const correctBird = sampleBirds.us[0];
      const options1 = generatePracticeAnswerOptions(
        "us",
        sampleBirds,
        0,
        correctBird,
      ...
      const options2 = generatePracticeAnswerOptions(
        "us",
        sampleBirds,
        0,
        correctBird,
