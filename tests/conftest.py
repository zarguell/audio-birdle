        ...
        "us": [
            {
                ...
                "audioUrl": [
                    "https://example.com/robin1.mp3",
                    "https://example.com/robin2.mp3",
                ],
            },
            {
                "id": "barswa",
...
def sample_regions_data():
    """Sample regions data"""
    return [{"id": "us", "name": "United States"}, {"id": "eu", "name": "Europe"}]
...
def sample_daily_data():
    ...
    return [{"date": "2025-12-27", "region": "us", "answerHash": "a1b2c3d4"}]
