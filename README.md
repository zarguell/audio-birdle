...
- Automated Deployment: Daily challenge generation and deployment handled by GitHub Actions.
...
- Statistics Tracking: Track your wins, streaks, and performance across regions and game modes.
...
- Add support for more regions and broader bird species data (international expansion).
...
- Add optional image clues or fun bird facts.
- Additional statistics and scoring metrics, including historic view of challenges.
- Subregion-specific daily challenges for more localized birding experiences.
...
- Want to contribute code? Please fork the repo, create a feature branch, and submit a pull request. Be sure to follow best practices (we have linters and test infrastructure in place!).
